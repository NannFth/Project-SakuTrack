...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white font-sans">
      ...
      {/* Form Register */}
      <div className="flex-1 lg:w-1/2 flex items-center justify-center p-4 bg-slate-100 lg:bg-slate-50">
        <div className="w-full max-w-[280px] lg:max-w-[420px] bg-white p-6 lg:p-12 rounded-xl lg:rounded-3xl shadow-md lg:shadow-none lg:bg-transparent border border-slate-200 lg:border-none">
          ...
          <div className="lg:hidden text-center mb-6">
            <div className="inline-block p-2 bg-slate-900 rounded-lg mb-3 shadow-md">
               <Wallet className="text-white" size={24} />
            </div>
            <h2 className="text-lg font-bold text-slate-900 tracking-tighter uppercase">SakuTrack</h2>
          </div>

          <div className="mb-6 lg:mb-10 text-center lg:text-left">
            <h3 className="text-2xl lg:text-3xl font-bold text-slate-900">Buat Akun</h3>
            <p className="text-slate-500 mt-1 text-[10px] lg:text-sm font-medium">Mulai langkah awal menuju finansial yang lebih tertata.</p>
          </div>

          <div className="space-y-3 lg:space-y-4">
            <div className="space-y-1">
              <label className="text-[10px] lg:text-sm font-bold text-slate-700 ml-1">Nama</label>
              <input 
                type="text" 
                placeholder="Masukkan nama Anda" 
                value={name} 
                onChange={(e) => setName(e.target.value)} 
                className="w-full p-3 lg:p-4 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-slate-900 text-[10px] lg:text-sm font-semibold" 
              />
            </div>

            <div className="space-y-1">
              <label className="text-[10px] lg:text-sm font-bold text-slate-700 ml-1">Email</label>
              <input 
                type="email" 
            ...
            <div className="space-y-1">
              <label className="text-[10px] lg:text-sm font-bold text-slate-700 ml-1">Password</label>
              <input 
                type="password" 
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <span className="px-3 text-[9px] text-slate-400 font-bold whitespace-nowrap tracking-widest uppercase">ATAU</span>
            <hr className="w-full border-slate-200" />
          </div>
          ...
          <div className="mt-8 text-center text-[10px] lg:text-sm">
            <span className="text-slate-400 font-medium">Sudah punya akun? </span>
